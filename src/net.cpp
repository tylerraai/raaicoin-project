...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Raaicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"raaicointools.com", "67.205.136.115"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"raaicointools.com", "testnet-seed.raaicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Raaicoin is probably already running."), addrBind.ToString().c_str());
        else
